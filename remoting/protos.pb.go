...
type MessageEnvelope struct {
	...
	Target      *process.ID `protobuf:"bytes,3,opt,name=target" json:"target,omitempty"`
	Sender      *process.ID `protobuf:"bytes,4,opt,name=sender" json:"sender,omitempty"`
}
...
func (m *MessageEnvelope) GetTarget() *process.ID {
	if m != nil {
		return m.Target
	}
	return nil
...
func (m *MessageEnvelope) GetSender() *process.ID {
	if m != nil {
		return m.Sender
	}
	return nil
...
func (m *ActorPidResponse) GetPid() *process.ID {
	if m != nil {
		return m.Pid
	}
	return nil
...
func (this *MessageEnvelope) String() string {
	...
	s := strings.Join([]string{`&MessageEnvelope{`,
		...
		`Target:` + strings.Replace(fmt.Sprintf("%v", this.Target), "ID", "process.ID", 1) + `,`,
		`Sender:` + strings.Replace(fmt.Sprintf("%v", this.Sender), "ID", "process.ID", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorProtos = []byte{
	...
	,
}
