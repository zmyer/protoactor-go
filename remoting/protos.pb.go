...
type MessageEnvelope struct {
	...
	Target      *process.PID `protobuf:"bytes,3,opt,name=target" json:"target,omitempty"`
	Sender      *process.PID `protobuf:"bytes,4,opt,name=sender" json:"sender,omitempty"`
}
...
func (m *MessageEnvelope) GetTarget() *process.PID {
	if m != nil {
		return m.Target
	}
	return nil
...
func (m *MessageEnvelope) GetSender() *process.PID {
	if m != nil {
		return m.Sender
	}
	return nil
...
func (m *ActorPidResponse) GetPid() *process.PID {
	if m != nil {
		return m.Pid
	}
	return nil
...
func (this *MessageEnvelope) String() string {
	...
	s := strings.Join([]string{`&MessageEnvelope{`,
		...
		`Target:` + strings.Replace(fmt.Sprintf("%v", this.Target), "PID", "process.PID", 1) + `,`,
		`Sender:` + strings.Replace(fmt.Sprintf("%v", this.Sender), "PID", "process.PID", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorProtos = []byte{
	...
	,
}
